...
function processOrders(orders, productCategoryMap = {}) {
  ...
  for (const order of orders) {
    ...
    if (!byDay[date]) byDay[date] = { date, country: 'at', orders: 0, orders_cancelled: 0, revenue_vat: 0, revenue: 0, cost: 0, cost_facebook: 0, cost_google: 0, clicks_facebook: 0, clicks_google: 0 };
